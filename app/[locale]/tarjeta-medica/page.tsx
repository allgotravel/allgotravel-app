      ...
      <div className="card-container max-w-3xl mx-auto bg-white rounded-2xl shadow-xl overflow-hidden">
        ...
        <div className="p-8 grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="flex flex-col items-center justify-start gap-4">
            <div className="w-36 h-36 border-4 border-dashed border-gray-300 rounded-xl flex flex-col items-center justify-center text-gray-400 text-center">
              <span className="text-4xl mb-1">📱</span>
              <span className="text-xs font-semibold tracking-widest">QR CODE</span>
            </div>
            ...
            <div className="mt-4 text-center">
              ...
              <p className="text-xs text-gray-400">allgotravel.com</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-[#0D9488] px-8 py-3 flex items-center justify-between">
          <p className="text-white text-xs opacity-80">
            🌍 allgotravel.com — Turismo accesible para todos
          </p>
