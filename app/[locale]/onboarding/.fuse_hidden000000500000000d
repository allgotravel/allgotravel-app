...
const DISABILITY_OPTIONS = [
  ...
  { id: 'visual',            emoji: '👁️', es: 'Baja visión',    en: 'Visual impairment' },
  { id: 'auditiva',          emoji: '👂', es: 'Baja audición',  en: 'Hearing impairment' },
  { id: 'autismo',           emoji: '🧩', es: 'Autismo',                en: 'Autism' },
  { id: 'cognitiva',         emoji: '🧠', es: 'Dificultad cognitiva', en: 'Cognitive disability' },
...
const FEATURES = [
  ...
  { es: '✈️ Planificador de viajes personalizado a tus necesidades',       en: '✈️ Trip planner personalized to your disability' },
    ...
    <div className="min-h-screen overflow-y-auto flex flex-col items-center pt-8 pb-12 px-4">
      ...
      >
        ...
        <p className="text-white/60 text-xs leading-snug">
          {t(
            'Cientos de viajeros con movilidad reducida ya confían en AllGo para cada viaje',
